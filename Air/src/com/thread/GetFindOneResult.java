...
public class GetFindOneResult extends Thread {
	private String str;
	...
	public GetFindOneResult(String str, int flag, JFrame jFrame) {
		this.str = str;
		this.jFrame = jFrame;
		this.flag = flag;
	}
		...
		case 3:
			...
			if (flightMap == null) {
				JOptionPane.showMessageDialog(this.jFrame,
						"没有该航班的信息！", "提示框", JOptionPane.CANCEL_OPTION);
			} else {
				FlightManager.showOne(str,flightMap.get("flight"));
			}
			break;
		case 4:
			pid = "order";
