...
import com.photo.utils.AlbumGridViewAdapter;
import com.photo.utils.AlbumHelper;
import com.photo.utils.Bimp;
import com.photo.utils.ImageBucket;
...
public class AlbumActivity extends Activity {
	...
	public ArrayList<String> listPic = new ArrayList<String>();
	...
	private void init() {
		...
		for(int i = 0; i<contentList.size(); i++){
			...
			for (int j=0; j < contentList.get(i).imageList.size(); j++) {
				listPic.add(contentList.get(i).imageList.get(j).imagePath);
			}
			
		}
		PublicWay.num = dataList.size();
